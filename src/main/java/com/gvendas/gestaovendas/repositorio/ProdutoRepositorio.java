...
public interface ProdutoRepositorio extends JpaRepository<Produto, Long> {
        ...
        @Query
        ("SELECT prod FROM Produto prod WHERE prod.codigo = :codigo AND prod.categoria.codigo = :codigoCategoria")
        Optional<Produto> buscarPorCodigoProduto(Long codigo, Long codigoCategoria);
